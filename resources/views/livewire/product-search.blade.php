<div>
        ...
        <div class="flex flex-col md:flex-row gap-4 items-start">
            <div class="w-full md:w-1/3">
                ...
                <button 
                    ...
                    class="px-4 py-2 mt-5 bg-gradient-to-br from-primary-400 to-primary-600 hover:from-primary-500 hover:to-primary-700 text-primary-700 rounded-lg transition-all duration-200 flex items-center gap-2 shadow-md hover:shadow-lg"
                >
    ...
    <div class="bg-white rounded-xl shadow-lg border border-primary-100 overflow-hidden">
        <div class="grid grid-cols-12 bg-gradient-to-r from-primary-500 to-primary-600 px-6 py-4 text-primary-700 font-medium">
